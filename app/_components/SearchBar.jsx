    ...
    <div className="w-full">
      <div className="relative">
        <input
          ...
          name="search-games"
          id="search-games"
          className="focus-within:border-accent focus-within:bg-background placeholder:text-subtle-surface focus:bg-background focus:ring-accent bg-surface block w-full rounded-lg p-2.5 ps-10 focus:ring-1 focus:outline-none"
