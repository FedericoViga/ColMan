      ...
      <div className="mb-3 w-full">
        <div className="flex items-baseline gap-3">
          ...
          <button
            ...
            className={`text-primary cursor-pointer rounded-lg border-slate-600 p-1 text-sm ${isExpanded ? "!text-foreground border-2 !border-blue-500" : "border-primary border-2"}`}
          >
            Piattaforme
          </button>
          <span>
