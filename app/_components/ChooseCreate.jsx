...
function ChooseCreate() {
  ...
  return (
    <>
      ...
      <div
        className={`bg-background fixed right-7 bottom-7 flex ${!isOpen ? "size-12" : "hidden size-0"} items-center justify-center rounded border-2 border-blue-500 text-5xl`}
        onClick={() => setisOpen((isOpen) => !isOpen)}
      >
